<div class="cover-bg">
    <img class="cover-image" src="https://via.placeholder.com/1600x460" data-demo-src="../assets/img/demo/bg/4.jpg" alt="">
    <div class="avatar">
        <img id="user-avatar" class="avatar-image" src="https://via.placeholder.com/300x300" data-demo-src="../assets/img/vector/icons/logos/fastpizza.svg" alt="">
...
<div class="profile-menu is-hidden-mobile">
    <div class="menu-start">
        <a href="pages-main.html" class="button has-min-width">Timeline</a>
        <a href="pages-about.html" class="button has-min-width">About</a>
    </div>
    <div class="menu-end">
        <a href="pages-community.html" class="button has-min-width">Community</a>
        <a href="pages-photos.html" class="button has-min-width">Photos</a>
    </div>
</div>
