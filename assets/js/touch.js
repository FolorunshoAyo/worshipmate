...
$(document).ready((function() {
    ...
    e = function(e, t) {
        ...
        ,
        t.Manager.prototype.emit = (i = t.Manager.prototype.emit,
        function(t, o) {
            i.call(this, t, o),
    ...
    ,
    "function" == typeof define && define.amd ? define(["jquery", "hammerjs"], e) : "object" === ("undefined" == typeof exports ? "undefined" : _typeof(exports)) ? e(require("jquery"), require("hammerjs")) : e(jQuery, Hammer),
    $(".videos-sidebar").length && (window.matchMedia("(max-width: 767px)").matches || window.matchMedia("(max-width: 768px)").matches && window.matchMedia("(orientation: portrait)").matches ? i() : void 0 !== t && t.destroy(),
