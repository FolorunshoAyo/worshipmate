...
$(document).ready((function() {
    ...
    $(".pop-button").on("click", (function() {
        ...
        "follow-pop" == $(this).attr("id") ? $(this).hasClass("is-shifted") ? ($(this).removeClass("is-shifted"),
        iziToast.show({
            maxWidth: "280px",
            class: "success-toast",
        ...
        iziToast.show({
            ...
            timeout: 2500,
            zindex: 99999
        })) : "invite-pop" == $(this).attr("id") ? $(this).hasClass("is-shifted") ? ($(this).removeClass("is-shifted"),
        iziToast.show({
            maxWidth: "280px",
            class: "success-toast",
        ...
        iziToast.show({
            ...
            timeout: 2500,
            zindex: 99999
        })) : "chat-pop" == $(this).attr("id") && ($(".chat-wrapper").toggleClass("is-active"),
    ...
    $(".album-wrapper").on("click", (function() {
        ...
        void 0 !== e && ($(".album-image-grid").addClass("is-hidden"),
    ...
    $("#upload-cover").length) {
        ...
        $("#submit-cover-picture").on("click", (function(e) {
            ...
            i.croppie("result", {
                ...
                console.log("HTML RESULT", o)),
                i.src && (o = '<img src="' + i.src + '" />',
                console.log(o),
                $(".cover-image").attr("src", i.src),
    ...
    if ($("#upload-profile").length) {
        ...
        $("#submit-profile-picture").on("click", (function(e) {
            ...
            o.croppie("result", {
                ...
                i.src && (i.src,
                $(".cover-bg .avatar .avatar-image, #user-avatar-minimal").attr("src", i.src),
    ...
    $("#profile-photos, #pages-photos").length && ($(".photo-like").on("click", (function() {
        $(this).hasClass("is-liked") ? $(this).find("svg").removeClass("gelatine") : $(this).find("svg").addClass("gelatine"),
