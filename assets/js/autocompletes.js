        ...
        var r = {
            ...
            list: {
                ...
                onChooseEvent: function() {
                    ...
                    "status" === a ? ($("#activities-autocpl-wrapper, .is-activity").addClass("is-hidden"),
                    $("#mood-autocpl-wrapper").removeClass("is-hidden"),
                    openMoodDrop()) : "drinking" === a ? ($("#activities-autocpl-wrapper, .is-activity").addClass("is-hidden"),
                    $("#drinking-autocpl-wrapper").removeClass("is-hidden"),
                    openDrinksDrop()) : "eating" === a ? ($("#activities-autocpl-wrapper, .is-activity").addClass("is-hidden"),
                    $("#eating-autocpl-wrapper").removeClass("is-hidden"),
                    openEatsDrop()) : "reading" === a ? ($("#activities-autocpl-wrapper, .is-activity").addClass("is-hidden"),
                    $("#reading-autocpl-wrapper").removeClass("is-hidden"),
                    openReadsDrop()) : "watching" === a ? ($("#activities-autocpl-wrapper, .is-activity").addClass("is-hidden"),
                    $("#watching-autocpl-wrapper").removeClass("is-hidden"),
                    openWatchDrop()) : "travelling" === a && ($("#activities-autocpl-wrapper, .is-activity").addClass("is-hidden"),
        ...
        var d = {
            ...
            list: {
                ...
                onChooseEvent: function() {
                    ...
                    $(".mood-display").length && $(".mood-display").remove(),
                    $.when($("#options-summary").prepend(a)).done((function() {
            ...
            e.geocode({
                ...
                for (i = 0; i < a.length; i++)
                    for (var e = 0; e < a[i].address_components.length; e++)
                        for (var t = 0; t < a[i].address_components[e].types.length; t++)
                            "postal_code" == a[i].address_components[e].types[t] && (zipcode = a[i].address_components[e].short_name,
