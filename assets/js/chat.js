...
$(document).ready((function() {
    ...
    $("#chat-sidebar .user-item").on("click", (function() {
        ...
        $("#" + a + "-conversation").removeClass("is-hidden"),
        $(".panel-body").addClass("is-hidden"),
        $("#" + a + "-details").removeClass("is-hidden"),
        $(".recipient-block").find(".user-avatar").attr("src", e),
        $(".recipient-block").find(".username span:first-child").text(s),
        $(".recipient-block").find(".username span span").text("| " + t)
    }
    ))
}
));
