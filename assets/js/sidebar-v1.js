...
function initSidebarV1() {
    if ($(".sidebar-v1").length) {
        ...
        $("*[data-open-sidebar]").length && window.matchMedia("(min-width: 768px)").matches && window.matchMedia("(orientation: landscape)").matches && openSidebarV1(),
        $("*[data-page-title]").length) {
