...
$(document).ready((function() {
    $("#activity-feed").length && $(".feed-menu-v1").length && ($(".feed-menu-v1 .main-menu li.is-active").find(".submenu").slideDown(),
    ...
    $(".share-dropdown .dropdown-item").on("click", (function() {
        var i = $(this).attr("data-target-channel")
          ...
          , s = $(this).find("h3").text();
        void 0 !== i && ($(".share-dropdown .button").find("i").removeClass().addClass(e),
        $(".share-dropdown .button").find("span").text(s),
        $(".share-channel-control").addClass("is-hidden"),
        $(".footer-action.is-active").removeClass("is-active"),
        $("#share-to-" + i).removeClass("is-hidden").find("input").focus())
    }
    )),
    ...
    $(".action-wrap .footer-action").on("click", (function() {
        ...
        void 0 !== i && ($(".bottom-share-inputs .field").addClass("is-hidden"),
        $("#action-" + i).removeClass("is-hidden").find("input").focus())
    }
    ))),
